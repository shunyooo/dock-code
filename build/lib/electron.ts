...
export const config = {
	...
	companyName: 'dock-code contributors',
	copyright: 'Copyright (C) 2025 dock-code contributors. All rights reserved',
	darwinExecutable: product.nameShort,
	darwinIcon: 'resources/darwin/code.icns',
	darwinBundleIdentifier: product.darwinBundleIdentifier,
	darwinApplicationCategoryType: 'public.app-category.developer-tools',
	darwinHelpBookFolder: 'dock-code HelpBook',
	darwinHelpBookName: 'dock-code HelpBook',
